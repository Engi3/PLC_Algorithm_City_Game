  ...
  return (
    <div className="flex min-h-screen flex-1 flex-col">
      <div className="flex flex-1 flex-col md:flex-row">
        ...
        <main className="min-w-0 flex-1 bg-zinc-50 p-4 dark:bg-black sm:p-6 lg:p-8 xl:mx-auto xl:w-full xl:max-w-[1600px] xl:p-10">
          {children}
        </main>
      </div>
...
function Footer() {
  return (
    <footer className="border-t border-zinc-200 bg-white px-4 py-4 text-center text-xs text-zinc-500 dark:border-zinc-800 dark:bg-zinc-950 dark:text-zinc-400">
